...
let repo =`
*╭──────────────●●►*
*| 𝙾𝚆𝙽𝙴𝚁 𝙽𝚄𝙼𝙱𝙴𝚁:* 94771098429
*| 𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳 𝚁𝙴𝙿𝙾:* https://github.com/Koyeb-LK/Queen_Queen_Ahinsa-MD
...
let buttons = [{
        ...
        buttonParamsJson: JSON.stringify({
            ...
            merchant_url: "https://github.com/Koyeb-LK/Queen_Ahinsa-MD"
            }),}]

    let message = {
                    image: LOGO,
                    header: '*Queen_Ahinsa-MD REPO*',
                    footer: FOOTER,
                    body: repo
...
let buttons = [{
        ...
        buttonParamsJson: JSON.stringify({
            display_text: "GITHUB",
            url: "https://github.com/Koyeb-LK/Queen_Queen_Ahinsa-MD",
            merchant_url: "https://github.com/Koyeb-LK/Queen_Ahinsa-MD"
        }),},
